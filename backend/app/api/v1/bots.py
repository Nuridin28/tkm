"""
Bot Management API - управление Telegram и WhatsApp ботами
"""
...
# Пути к ботам (относительно корня проекта)
BOT_PATHS = {
...
def get_project_root() -> str:
    ...
    # От backend/app/api/v1/bots.py до корня проекта
...
async def list_bots(
    ...
    """Получить список всех ботов и их статусы"""
    bots = []
