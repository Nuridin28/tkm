"""
Ingest endpoint - receive tickets from various sources
"""
...
async def ingest_ticket(
    ...
    """
    Ingest ticket from various sources (email, chat, portal, phone, call_agent)
    """
    try:
        # Create ticket
        ticket_data = {
        ...
        # Process with AI (async in production, sync for now)
