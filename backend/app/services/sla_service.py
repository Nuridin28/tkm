"""
SLA Service - SLA monitoring and escalation
"""
...
class SLAService:
    ...
    async def check_sla_violations(self) -> List[Dict[str, Any]]:
        ...
        # Get tickets with passed SLA deadlines
    ...
    def _log_ticket_history(self, ticket_id: str, field_name: str, old_value: str, new_value: str, changed_by: str = "system"):
        """Log ticket history change"""
        history_data = {
            "ticket_id": ticket_id,
            "field_name": field_name,
            "old_value": str(old_value),
            "new_value": str(new_value),
            "changed_by": None,  # Would be user ID in real scenario
